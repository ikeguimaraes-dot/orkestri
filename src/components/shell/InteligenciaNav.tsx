...
const LINKS = [
  ...
  { href: "/inteligencia/adocao", label: "Adoção" },
  { href: "/inteligencia/cross", label: "Cross" },
  { href: "/inteligencia/feedback", label: "Feedback" },
  { href: "/inteligencia/metas", label: "Metas" },
  { href: "/inteligencia/roadmap", label: "Roadmap" },
  { href: "/inteligencia/wbr", label: "WBR" },
];
